	...
	override function update(elapsed:Float)
	{
		...
		if (controls.ACCEPT)
		{
			...
			switch (daSelected)
			{
				...
				/*case "Youtube":
					#if linux
						Sys.command('/usr/bin/xdg-open', ["https://www.youtube.com/channel/UCV8i9KKPbOm_a-7PA8XksTg", "&"]);
					#else
						FlxG.openURL('https://www.youtube.com/channel/UCV8i9KKPbOm_a-7PA8XksTg', "_self");
					#end*/
				case "Restart Song":
